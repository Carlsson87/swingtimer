...
var author$project$Main$SelectSets = {$: 'SelectSets'};
...
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(author$project$Main$SelectSets, elm$core$Platform$Cmd$none);
};
...
var author$project$Main$subscriptions = function (model) {
	if (model.$ === 'ShowTimer') {
		var state = model.a;
		return state.paused ? elm$core$Platform$Sub$none : A2(
			elm$time$Time$every,
			1000,
...
var author$project$Main$ShowTimer = function (a) {
	return {$: 'ShowTimer', a: a};
};
var author$project$Main$TimerState = F4(
	function (nrOfSets, setsRemaining, second, paused) {
		return {nrOfSets: nrOfSets, paused: paused, second: second, setsRemaining: setsRemaining};
	});
var elm$core$Basics$not = _Basics_not;
var author$project$Main$update = F2(
	function (msg, model) {
		if (model.$ === 'SelectSets') {
			if (msg.$ === 'SelectNrOfSets') {
				var sets = msg.a;
				return _Utils_Tuple2(
					author$project$Main$ShowTimer(
						A4(author$project$Main$TimerState, sets, sets, 0, true)),
			...
			switch (msg.$) {
				case 'Tick':
					return _Utils_Tuple2(
						(state.second === 59) ? author$project$Main$ShowTimer(
							_Utils_update(
								state,
								{second: 0, setsRemaining: state.setsRemaining - 1})) : author$project$Main$ShowTimer(
							_Utils_update(
								state,
...
var author$project$Main$SelectNrOfSets = function (a) {
	return {$: 'SelectNrOfSets', a: a};
};
...
var author$project$Main$selectSets = function (n) {
	return A2(
		elm$html$Html$h1,
		_List_fromArray(
			[
				elm$html$Html$Events$onClick(
				author$project$Main$SelectNrOfSets(n))
			]),
		_List_fromArray(
			[
				elm$html$Html$text(
...
var author$project$Main$radialProgress = function (progress) {
	return A2(
		elm$svg$Svg$svg,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$svg$Svg$Attributes$r('54'),
						elm$svg$Svg$Attributes$cx('60'),
						elm$svg$Svg$Attributes$cy('60'),
						elm$svg$Svg$Attributes$fill('none'),
						elm$svg$Svg$Attributes$stroke('white'),
						elm$svg$Svg$Attributes$strokeWidth('12'),
						elm$svg$Svg$Attributes$strokeDasharray('339.292'),
						elm$svg$Svg$Attributes$transform('rotate(-90, 60, 60)'),
			...
			[
				...
				_List_fromArray(
					[
						...
						A2(elm$html$Html$Attributes$style, 'margin', '50px auto 0 auto'),
						A2(elm$html$Html$Attributes$style, 'position', 'relative')
					]),
				_List_fromArray(
					[
						author$project$Main$radialProgress(model.second),
						A2(
						elm$html$Html$h1,
						_List_fromArray(
							[
								...
								A2(elm$html$Html$Attributes$style, 'line-height', '100px')
							]),
						_List_fromArray(
							[
								elm$html$Html$text(
								elm$core$String$fromInt(model.second))
							]))
					])),
				A2(
				elm$html$Html$h1,
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						elm$core$String$fromInt(model.nrOfSets - model.setsRemaining)),
						elm$html$Html$text(' / '),
						elm$html$Html$text(
						elm$core$String$fromInt(model.nrOfSets))
					])),
				A2(
				elm$html$Html$h1,
				_List_fromArray(
				...
				_List_fromArray(
					[
						model.paused ? elm$html$Html$text('Start') : elm$html$Html$text('Pause')
					]))
			]));
};
...
var author$project$Main$view = function (model) {
	if (model.$ === 'SelectSets') {
		return A2(
			...
			A2(
				elm$core$List$map,
				author$project$Main$selectSets,
				A2(elm$core$List$range, 1, 30)));
	} else {
		var state = model.a;
		return author$project$Main$timerView(state);
	}
};
